...
from securosurf_gui import gui_make_allow_list_frame
from securosurf_gui import gui_make_performance_frame
from securosurf_gui import gui_make_game_status_frame
from securosurf_gui import gui_make_T2_throttling_frame
...
def FUNC() -> tk.Container:
    ...
    return tk.Container([
        ...
        [gui_make_T2_throttling_frame.FUNC()],
        [gui_make_allow_list_frame.FUNC()],
